...
\end{itemize}
\begin{figure}[H]
        \makebox[\textwidth][c]{\includegraphics[width=\textwidth, height=\textheight,keepaspectratio]{HC05_highlevel.png}}
...
\hline
7 & 0x1C & \multicolumn{7}{c|}{Unused} & \texttt{reset\_FIFO\_out} & \texttt{reset\_FIFO\_in} & W\\
\hline
\end{tabular}}
\begin{center}
\begin{tabular}{|c|c|c|}
